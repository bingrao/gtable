...
class CTGANSynthesizer(BaseSynthesizer):
    ...
    def run(self, args):
        if args.tsv:
            data, discrete_columns = read_tsv(args.real_data, args.metadata)
        else:
            data, discrete_columns = read_csv(args.real_data, args.metadata, args.header, args.discrete)

        # if args.load:
        #     model = self.load(args.load)
        # else:
        #     model = CTGANSynthesizer()

        self.fit(data, discrete_columns, args.epoch)
